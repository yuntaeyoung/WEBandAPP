...
public class BikeInfoPostRequest extends AsyncTask<JSONObject, Void, String> {
        Activity activity;
        URL url;

public BikeInfoPostRequest(Activity activity) {
...
protected void onPostExecute(String result) {
        ...
        String temp;
        String messageFailed = "예약실패";
        String messageOk = "예약성공";
        temp = result.trim();
